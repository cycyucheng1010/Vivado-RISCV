...
////////// start copy1
class CtrlModule1(val W: Int, val S: Int)(implicit val p: Parameters) extends Module
  with HasCoreParameters
  with MemoryOpConstants {
  val r = 2*256
  val c = 25*W - r
...
///////// start copy2
class CtrlModule2(val W: Int, val S: Int)(implicit val p: Parameters) extends Module
  with HasCoreParameters
  with MemoryOpConstants {
  val r = 2*256
  val c = 25*W - r

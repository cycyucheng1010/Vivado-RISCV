...
///// start copy1
class DpathModule1(val W: Int, val S: Int)(implicit p: Parameters) extends Module {
  //constants
  val r = 2*256
  val c = 25*W - r
  val round_size_words = c/W
...
///// start copy2
class DpathModule2(val W: Int, val S: Int)(implicit p: Parameters) extends Module {
  //constants
  val r = 2*256
  val c = 25*W - r
  val round_size_words = c/W
